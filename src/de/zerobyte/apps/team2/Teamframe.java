...
/**
 * Title:        Team 2 <p>
 * Description:  Gruppeneinteilungsprogramm f�r Ferienfreizeiten...
 * Version f�r Java 2 Plattform<p>
...
public class Teamframe extends JFrame implements PropertyChangeListener {
  ...
  private void jbInit() throws Exception  {
    ...
    menuHelpAbout.setToolTipText("Informationen �ber das Programm");
    ...
    jButton1.setToolTipText("die ausgew�hlten Personendaten �ndern");
    jButton1.setText("Person �ndern");
    ...
    jButton2.setToolTipText("Die ausgew�hlte Persondaten l�schen");
    jButton2.setText("Person l�schen");
    ...
    jCheckBox1.setToolTipText("Wenn m�nnlich, dann ausw�hlen");
    jCheckBox1.setText("m�nnlich");
    ...
    jCheckBox2.setToolTipText("Wenn m�nnlich, dann ausw�hlen");
    jCheckBox2.setText("m�nnlich");
    ...
    geschlechtaendern.setText("m�nnlich");
    geschlechtaendern.setToolTipText("Wenn m�nnlich, dann ausw�hlen");
    ...
    personenaendern.setTitle("Personendaten �ndern");
    ...
    jLabel11.setText("Selektierte Person wirklich l�schen ?");
    jDialog1.setTitle("Personendaten l�schen");
    ...
    jLabel13.setText("Gew�nschte Teamanzahl:");
    ...
    jCheckBoxMenuItem1.setToolTipText("Soll das Geschlecht der Person bei der Einteilung ber�cksichtigt " +
    "werden?");
    ...
    jCheckBoxMenuItem2.setToolTipText("Soll das Alter bzw. die angegebene Bewertung ber�cksichtigt werden " +
    "?");
  ...
  void jMenuItem3_actionPerformed(ActionEvent e) {
    ...
    if (personenspeichern.showSaveDialog(this)==JFileChooser.APPROVE_OPTION) {
      ...
      // jetzt File an teamKern1 �bergeben, damit gespeichert werden kann
